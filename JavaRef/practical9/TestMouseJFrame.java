...
// us the location of the mouseClick that generated the event.
   ...
   public void mousePressed(MouseEvent e){//when the mouse is pressed
	   int xLocation = e.getX();//gets X co-ordinate of mouse
	    int yLocation = e.getY();//gets Y co-ordinate of mouse
	    
	    circleXcenter = xLocation-circleRadius;
	    circleYcenter = yLocation-circleRadius;
	    repaint();
	    show = true;//prints the circle when true
   }

   public void mouseReleased(MouseEvent e){//when the mouse press is released
